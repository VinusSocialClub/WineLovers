const translations = {
  en: {
    ...
    wine_tasting: "🍷 Learn and enjoy the art of wine tasting with our exclusive videos.",
  ...
  pt: {
    ...
    wine_tasting: "🍷 Aprende e desfruta da arte da prova de vinhos com os nossos vídeos exclusivos.",
  ...
  fr: {
    ...
    wine_tasting: "🍷 Apprenez et profitez de l'art de la dégustation de vin avec nos vidéos exclusives.",
  ...
  de: {
    ...
    wine_tasting: "🍷 Lerne und genieße die Kunst der Weinverkostung mit unseren exklusiven Videos.",
